...
void Mesh::InitMesh(unsigned int Index, const aiMesh* paiMesh)
{
    ...
    for (unsigned int i = 0 ; i < paiMesh->mNumFaces ; i++) {
        ...
        if(Face.mNumIndices != 3){
            cout << "WARNING: face does not have 3 indices! Your mesh might have been degenerated by decimate operation, use bigger value" << endl;
            continue;
        }
